...
resource "aws_wafv2_ip_set" "blocked_ips" {
  ...
  name               = "blocked-ips-dev"                 # IPSet 이름
  description        = "Blocked IP list for malicious and VPN addresses DEV"
